...
def mergeAllData():
    ...
    #ec2_ip = pd.DataFrame(ec2_ip_json)
    #ec2_df = ec2_df.merge(ec2_ip, on='VPCID', how='left')
...
def api_all_services_data():
    ...
    all_services_data = mergeAllData()
    return all_services_data
